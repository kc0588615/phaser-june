...
Code lives under `src/` (React + Phaser game + Cesium map) with Supabase integration in `src/lib/`. See the onboarding doc for the full navigation map and links to every guide.
