...
### Current State: Denormalized (1NF Violations)

The `icaa` table contains **repeating groups** that violate First Normal Form:
...
- **Keep denormalized** if you only display data (current game use case)
