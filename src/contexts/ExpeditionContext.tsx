...
export function ExpeditionProvider({ children }: { children: React.ReactNode }) {
  ...
  const emitBoardTracked = useCallback((payload: EventPayloads['expedition-data-ready'], publicCase: PublicCaseSnapshot, nodeIndex: number, objectiveProgress: number, bestTargetMatchLength = 0, boardCheckpoint?: EventPayloads['cesium-location-selected']['boardCheckpoint']) => {
