...
export const playerGameSessions = pgTable(
  'player_game_sessions',
  {
    ...
    cluesUnlockedInSession: integer('clues_unlocked_in_session').notNull().default(0),
...
export const playerStats = pgTable('player_stats', {
  ...
  totalCluesUnlocked: integer('total_clues_unlocked').notNull().default(0),
  totalScore: integer('total_score').notNull().default(0),
  ...
  cluesByCategory: jsonb('clues_by_category').notNull().default(sql`'{}'::jsonb`),
